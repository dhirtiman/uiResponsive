...
export default function AnnouncementBar() {
  return (
    <div className="border-neutral-1000 flex h-auto w-[375px] flex-col items-center-safe gap-2 border-b p-2 md:w-192 md:px-8 lg:w-full ">
      {/* container */}
      <div className="flex w-full min-w-90 flex-col gap-2  md:min-w-176 lg:w-304">
        ...
        <div className="flex w-[359px] flex-row gap-4 self-center md:w-[568px]">
          <Button mode="grey" size="small" icon="none" className="">
            Announcement
          </Button>
